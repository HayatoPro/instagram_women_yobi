...
<html>
    ...
    <body>
        ...
        <div class="button">
            <a href="https://lin.ee/akIVFGh" target="_blank" class="btn-square-little-rich">公式LINEサポート <i class="fas fa-chevron-circle-right"></i></a>
        </div>
        ...
        <a href="https://lin.ee/akIVFGh" target="_blank" class="btn-square-little-rich"><img src="{{ asset('image/line_friend_add.png') }}"></img></a>
        <br>
        <br>
        <div class="button">
